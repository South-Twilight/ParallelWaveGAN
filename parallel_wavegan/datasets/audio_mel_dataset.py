...
class AudioMRTokenlDataset(Dataset):
    ...
    def __init__(
        ...
        mel_query="*.h5",
        resolution_query="*.h5",
        resolution_load_fn=lambda x: read_hdf5(x, "resolutoin"),
        local_query=None,
        local_load_fn=None,
        global_query=None,
        global_load_fn=None,
        ...
        Args:
            ...
            resolution_query (str): Query to find resolution file in root_dir.
            resolution_load_fn (func): Function to load resolution info.
        ...
        if mel_length_threshold is not None:
            ...
            for rs in resolution:
                ...
                idxs = [
                    ...
                    if mel_lengths[idx] > mel_length_threshold // (rs / src_rs)
                ]
                if len(mel_files) != len(idxs):
                    logging.warning(
                        f"Some files are filtered by mel length threshold with resolution {rs}"
